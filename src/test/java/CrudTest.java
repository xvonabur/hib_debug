import com.example.hib_debug.dao.ITypedDao;
...
public abstract class CrudTest<KEY extends Serializable, EN extends Persistent<KEY>> extends JUnitTest {
	 ...
	 * 
	 * @return a valid non-persistent instance of {@link com.example.hib_debug.Persistent}
	 */
	 ...
	 * 
	 * @return an instance of the DAO that manages the {@link com.example.hib_debug.Persistent} of the tests
	 */
