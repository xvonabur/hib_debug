 ...
 * is abstracted using an implementation of {@link com.example.hib_debug.dao.IPersistenceProvider}. The {@link com.example.hib_debug.dao.IPersistenceProvider} interface is designed to be generic, meaning that any
 * domain object can be accessed using the same {@link com.example.hib_debug.dao.IPersistenceProvider} instance.
 * For type-safety there also exists a typed interface {@link com.example.hib_debug.dao.ITypedDao} which uses generics to offer the same methods as {@link com.example.hib_debug.dao.IPersistenceProvider}
 * but limited by type to one domain object class.
 * Every domain object that implements this interface is automatically persistable using implementation of {@link com.example.hib_debug.dao.IPersistenceProvider} or {@link ITypedDao}.
 *  
