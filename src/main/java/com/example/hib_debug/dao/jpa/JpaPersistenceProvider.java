...
import com.example.hib_debug.dao.IPersistenceProvider;
import com.example.hib_debug.dao.IUnitOfWork;
import com.example.hib_debug.dao.query.LockType;
...
/**
 * An implementation of {@link com.example.hib_debug.dao.IPersistenceProvider} interface for JPA 2 persistence technology.
 * 
...
public abstract class JpaPersistenceProvider implements IPersistenceProvider {
	...
	@Override
	public <D extends Persistent<? extends Serializable>> D findById(Class<D> domainClass, Serializable id, Options.AccessPlan options) {
		if (id == null) {
			return null;
		}
