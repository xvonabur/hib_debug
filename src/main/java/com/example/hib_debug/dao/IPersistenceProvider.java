 ...
 * {@link com.example.hib_debug.Persistent}. The same persistence provider instance can be shared among multiple
 * instances DAOs.
 * 
...
public interface IPersistenceProvider {
	 ...
	 * 
	 * @param <E>
	 *            any subtype of {@link com.example.hib_debug.Persistent} welcome
	 * @param domainClass
	 ...
	 * 
	 * @param <E> Any subtype of {@link com.example.hib_debug.Persistent} welcome
	 ...
	 * @return the domain object with the given id or null if such an object does not exist
	 */
	<E extends Persistent<? extends Serializable>> E findById(Class<E> domainClass, Serializable id, Options.AccessPlan options);
	

	/**
	 * The method is used to persist an instance of {@link com.example.hib_debug.Persistent} to the underlying storage
	 * 
	 * @param <E> Any subtype of {@link com.example.hib_debug.Persistent} welcome
	...
	/**
	 * The method is used to persist a list of instances of {@link com.example.hib_debug.Persistent}. It applies the semantics
     ...
     * @return
     */
	<E extends Persistent<? extends Serializable>> List<E> findAll(Class<E> domainClass, Query.TypedQuery query);
     ...
     * @return
     */
	<E extends Persistent<? extends Serializable>> E find(Class<E> domainClass, Query.TypedQuery query);
